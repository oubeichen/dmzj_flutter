...
String chapter_name,
int progress,
}):_uid=uid,_type=type,_comic_id=comic_id,_chapter_id=chapter_id,_record=record,_viewing_time=viewing_time,_comic_name=comic_name,_cover=cover,_chapter_name=chapter_name,_progress=progress;
  factory ComicHistoryItem.fromJson(jsonRes)=>jsonRes == null? null:ComicHistoryItem(    uid : jsonRes['uid'],
    type : jsonRes['type'],
