...
String num,
String tag_id,
}):_comic_id=comic_id,_title=title,_authors=authors,_status=status,_cover=cover,_types=types,_last_updatetime=last_updatetime,_last_update_chapter_name=last_update_chapter_name,_comic_py=comic_py,_num=num,_tag_id=tag_id;
  factory ComicRankItem.fromJson(jsonRes)=>jsonRes == null? null:ComicRankItem(    comic_id : jsonRes['comic_id'],
    title : jsonRes['title'],
