...
}):_id=id,_is_passed=is_passed,_top_status=top_status,_is_goods=is_goods,_upload_images=upload_images,_obj_id=obj_id,_content=content,_sender_uid=sender_uid,_like_amount=like_amount,_create_time=create_time,_to_uid=to_uid,_to_comment_id=to_comment_id,_origin_comment_id=origin_comment_id,_reply_amount=reply_amount,_hot_comment_amount=hot_comment_amount,_cover=cover,_nickname=nickname,_avatar_url=avatar_url,_sex=sex,_masterComment=masterComment,_masterCommentNum=masterCommentNum;
  factory CommentItem.fromJson(jsonRes){ if(jsonRes == null) return null;
    List<MasterCommentItem> masterComment = jsonRes['masterComment'] is List ? []: null; 
    if(masterComment!=null) {
 for (var item in jsonRes['masterComment']) { if (item != null) { masterComment.add(MasterCommentItem.fromJson(item));  }
    }
    }


return CommentItem(    id : jsonRes['id'],
...
int hot_comment_amount,
int sex,
}):_id=id,_is_passed=is_passed,_top_status=top_status,_is_goods=is_goods,_upload_images=upload_images,_obj_id=obj_id,_content=content,_sender_uid=sender_uid,_like_amount=like_amount,_create_time=create_time,_to_uid=to_uid,_to_comment_id=to_comment_id,_origin_comment_id=origin_comment_id,_reply_amount=reply_amount,_cover=cover,_nickname=nickname,_hot_comment_amount=hot_comment_amount,_sex=sex;
  factory MasterCommentItem.fromJson(jsonRes)=>jsonRes == null? null:MasterCommentItem(    id : jsonRes['id'],
    is_passed : jsonRes['is_passed'],
    top_status : jsonRes['top_status'],
    is_goods : jsonRes['is_goods'],
    upload_images : jsonRes['upload_images'],
