...
}):_id=id,_last_update_time=last_update_time,_name=name,_types=types,_cover=cover,_authors=authors,_last_update_chapter_name=last_update_chapter_name,_top=top,_subscribe_amount=subscribe_amount;
  factory NovelRankItem.fromJson(jsonRes){ if(jsonRes == null) return null;
...
return NovelRankItem(    id : jsonRes['id'],
