...
}):_volume_id=volume_id,_id=id,_volume_name=volume_name,_volume_order=volume_order,_chapters=chapters;
  factory NovelVolumeItem.fromJson(jsonRes){ if(jsonRes == null) return null;
    List<NovelVolumeChapterItem> chapters = jsonRes['chapters'] is List ? []: null; 
    if(chapters!=null) {
 for (var item in jsonRes['chapters']) { if (item != null) { chapters.add(NovelVolumeChapterItem.fromJson(item));  }
    }
    }


return NovelVolumeItem(    volume_id : jsonRes['volume_id'],
    id : jsonRes['id'],
...
String chapter_name,
int chapter_order,
}):_chapter_id=chapter_id,_chapter_name=chapter_name,_chapter_order=chapter_order;
  factory NovelVolumeChapterItem.fromJson(jsonRes)=>jsonRes == null? null:NovelVolumeChapterItem(    chapter_id : jsonRes['chapter_id'],
