...
}):_comment_id=comment_id,_content=content,_reply_amount=reply_amount,_like_amount=like_amount,_origin_comment_id=origin_comment_id,_obj_id=obj_id,_create_time=create_time,_to_comment_id=to_comment_id,_obj_cover=obj_cover,_obj_name=obj_name,_page_url=page_url,_masterComment=masterComment;
  factory UserCommentItem.fromJson(jsonRes)=>jsonRes == null? null:UserCommentItem(    comment_id : jsonRes['comment_id'],
...
int reply_amount,
String nickname,
}):_id=id,_content=content,_sender_uid=sender_uid,_like_amount=like_amount,_create_time=create_time,_reply_amount=reply_amount,_nickname=nickname;
  factory UserMasterComment.fromJson(jsonRes)=>jsonRes == null? null:UserMasterComment(    id : jsonRes['id'],
    content : jsonRes['content'],
